...
void vp9_highbd_iht16x16_256_add_c(const tran_low_t *input, tran_high_t* dest, int stride, int tx_type, int bd);
...
void vp9_highbd_iht4x4_16_add_c(const tran_low_t *input, tran_high_t* dest, int stride, int tx_type, int bd);
...
void vp9_highbd_iht8x8_64_add_c(const tran_low_t *input, tran_high_t* dest, int stride, int tx_type, int bd);
